    ...
    <div id = "content">
        <div id="cora">
            <div class="item-1">
                ...
                <div class="data">
                    <select class="loaddata" name="example" id="exam" v-model="selectedName" @change="changefName($event)">
                        <option disabled value=''>example data</option>
                        <option v-for="(item, index) in list " :key="index" :value="item.fName">
                            {{item.fName}}
                     </option>
            ...
            <div class="item-5">
                <span style="color:red">Please load a dataset first!</span>
                <button class="example" value="VisCoAuthor_4" @click="exampleFile($event)">VisCoAuthor_4</button>
                <button class="example" value="VisCoAuthor_5" @click="exampleFile($event)">VisCoAuthor_5</button>
                <button class="example" value="VisCoAuthor_7" @click="exampleFile($event)">VisCoAuthor_7</button>
                <button class="example" value="VisCoAuthor_8" @click="exampleFile($event)">VisCoAuthor_8</button>
                <button class="example" value="VisCoAuthor_9" @click="exampleFile($event)">VisCoAuthor_9</button>
                <button class="example" value="VisCoAuthor_10" @click="exampleFile($event)">VisCoAuthor_10</button>
            ...
            <div class="item-2">
                ...
                <div class="MyGraphPara">
                        ...
                        <div style="font-size:20px; color:#515a6e; font-weight:bold">  t-fdp parameters </div>                  
                        <div class="range">
                            
                            <span style="justify-self: end; padding:5px"> α: </span>
                            <input type="number" min="0" max="1"  step=0.01 v-model.number="alpha"/>
                        ...
                        <div class="range">
                            ...
                            <input type="number" min="0" max="10"  step=0.5 v-model.number="beta"/>
                        </div>

                        <div class="range">
                            <span style="justify-self: end; padding:5px">γ:</span>
                            <input type="number" min="0" max="10"  step=0.1 v-model.number="gamma"/>                          
                        </div>
                ...
                <div class="default">
                    <div class="range">
                            ...
                            <input type="number" min="0" max="10"  step=0.1 v-model.number="stepsize"/>
                        </div>                      
                    <button class="button-rerun" value="rerun" @click="rerun($event)">rerun</button>
                ...
                <div class="extern">
                    ...
                    <div class="extern-default">
                        ...
                        <button class="extern-default-button1" value="evenly" @click="setpara($event)">evenly</button>
                        <button class="extern-default-button2" value="major" @click="setpara($event)">major</button>
                        <button class="extern-default-button3" value="refine" @click="refine($event)">refine</button>
                        <button disabled="disabled" class="extern-default-button4" value="local" @click="local($event)">local</button> 
...
export default {
  ...
  data () {
    return {
      ...
      list :[
          {id:1, fName:'VisCoAuthor_4'}, {id:2, fName:'VisCoAuthor_5'}, {id:3, fName:'VisCoAuthor_7'},
          {id:1, fName:'VisCoAuthor_8'}, {id:2, fName:'VisCoAuthor_9'}, {id:3, fName:'VisCoAuthor_10'},
          {id:1, fName:'sample_0'}, {id:2, fName:'sample_1'}, {id:3, fName:'sample_5'},
          {id:1, fName:'sample_9'}, {id:2, fName:'sample_10'}, {id:3, fName:'sample_18'},
          {id:1, fName:'sample_19'}, {id:2, fName:'sample_20'}, {id:3, fName:'sample_21'},
  ...
  watch: {
      ...
      comp(val, oldval) {
          ...
          if(!val) {
            ...
            document.getElementsByClassName("item-both")[0].style.gridTemplateColumns = "50% 50%";
          ...
          if(val) {//隐藏fdp的画布
            ...
            document.getElementsByClassName("item-both")[0].style.gridTemplateColumns = "100%";
            document.getElementsByClassName("fdpPara")[0].style.display = "none";
            document.getElementsByClassName("item-2")[0].style.gridTemplateRows = "80px auto";
